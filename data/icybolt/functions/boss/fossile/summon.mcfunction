...
summon block_display ~ ~ ~ {Tags:["icybolt","fossile","t2"],transformation:{left_rotation:[0f,0f,0f,1f],right_rotation:[0f,0f,0f,1f],translation:[-0.35f,.1f,-0.35f],scale:[.7f,.7f,.7f]},block_state:{Name:"minecraft:dragon_egg"},Glowing:1b,glow_color_override:5636095}
